...
{  /*
    int temp=0;
       ...
       if(Rook1.x!=King.x&&Rook1.y!=King.y)
         {
           if((Rook2.x!=King.x&&Rook2.y!=King.y)&&(Rook2.x!=Rook1.x&&Rook2.y!=Rook1.y))
            {temp=1;}
         }  
     return temp;
    /*/
...
int coordinate2(int xk,int yk,int x1,int y1,int x2,int y2)
{
   
	  int status=1,count=-1;
	  King.getdat(xk,yk);
      Rook1.getdat(x1,y1);
      Rook2.getdat(x2,y2);
...
int coordinate1(int xk,int yk,int x1,int y1,int x2,int y2)
{
...
int count;
void compare(int xk,int yk,int x1,int y1,int x2,int y2,int r1,int r2)
{
  if(r1!=r2)
  { ::count++;
    cout<<"  king : ( "<<xk<<","<<yk<<" )\n";  
    cout<<"Rook 1 : ( "<<x1<<","<<y1<<" )\n";  
    cout<<"Rook 2 : ( "<<x2<<","<<y2<<" )\n";
    cout<<" CORRECT ANSWER : "<<r1<<endl;
    cout<<"OPTAINED ANSWER : "<<r2<<endl;  
    cout<<"FAILED ! \n\n";
  }
}
...
{ 
  ...
  for(int i=1;i<=8;i++)
   ...
   { cout<<"TOTAL NO. OF TEST CASES : " <<total<<endl;
     cout<<"TOTAL NO. OF FAILED TEST CASES : "<<::count<<endl;
   }
   else 
    {cout<<"ALL ANSWERS ARE CORRECT \n";
     cout<<"TOTAL NO. OF TEST CASES : " <<total<<endl;
    }
    cin>>total;
    return 0;
